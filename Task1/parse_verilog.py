...
def generate_testbench(module, inputs, outputs, clock_info, reset_info, reset_order, data_info, data_order):#num_format
    ...
    tb_filename = f'{module_name}_tb.sv'
...
module {module_name}_tb;
    ...
    initial begin
    // VCD Dump commands
    $dumpfile("{module_name}_tb.vcd");  // Specify the name of the VCD file
    $dumpvars(0, {module_name}_tb );  // Dump variables from the testbench module
...
if __name__ == "__main__":
    verilog_file = 'piso_shift_register.v'
    print(f"Verilog file path: {verilog_file}")
    #tb_filename = 'generated_testbench_tb.v'
    extracted_info_filename = 'extracted_info_veri=.txt'
